...
_Bog'liq:_ yo'q. _Tugadi:_ bo'sh skeletда CI'da `pnpm build`/`lint`/`test` yashil.
...
_Bog'liq:_ 0.1. _Tugadi:_ dasturchi to'liq stekni lokal ishga tushira oladi va staging mavjud.
...
_Bog'liq:_ 4.4 (va funksiyalar hodisalari paydo bo'lgani sari).
...
_Bog'liq:_ yetuk, barqaror API'lar (4–7-bosqichlardan keyin).
